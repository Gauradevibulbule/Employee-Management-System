...
def home(request):
    ...
    return render(request, 'employee/dashboard.html',d)
...
def employee_list(request):
    emp_data = Employee.objects.filter()
    d = {'employee':emp_data}
    return render(request, 'employee/employee_list.html',d)
...
def edit_employee(request, pid):
    ...
    if request.method == "POST":
        ...
        return redirect('employee_list')
    return render(request, 'employee/edit_employee.html', {'emp_data':emp_data})
